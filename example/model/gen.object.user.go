...
func (m *_UserRedisMgr) BeginPipeline(pipes ...redis.Pipeliner) *_UserRedisPipeline {
	...
	return &_UserRedisPipeline{m.TxPipeline(), nil}
}
...
func (m *_UserRedisMgr) Delete(obj *User) error {
	...
	uk_pip_0 := MailboxPasswordOfUserUKRelationRedisMgr().BeginPipeline(pipe.TxPipeline())
	...
	idx_pip_0 := SexOfUserIDXRelationRedisMgr().BeginPipeline(pipe.TxPipeline())
	...
	rg_pip_0 := IdOfUserRNGRelationRedisMgr().BeginPipeline(pipe.TxPipeline())
	...
	rg_pip_1 := AgeOfUserRNGRelationRedisMgr().BeginPipeline(pipe.TxPipeline())
...
func (m *_MailboxPasswordOfUserUKRelationRedisMgr) BeginPipeline(pipes ...redis.Pipeliner) *_MailboxPasswordOfUserUKRelationRedisPipeline {
	...
	return &_MailboxPasswordOfUserUKRelationRedisPipeline{m.TxPipeline(), nil}
}
...
func (m *_SexOfUserIDXRelationRedisMgr) BeginPipeline(pipes ...redis.Pipeliner) *_SexOfUserIDXRelationRedisPipeline {
	...
	return &_SexOfUserIDXRelationRedisPipeline{m.TxPipeline(), nil}
}
...
func (m *_IdOfUserRNGRelationRedisMgr) BeginPipeline(pipes ...redis.Pipeliner) *_IdOfUserRNGRelationRedisPipeline {
	...
	return &_IdOfUserRNGRelationRedisPipeline{m.TxPipeline(), nil}
}
...
func (m *_AgeOfUserRNGRelationRedisMgr) BeginPipeline(pipes ...redis.Pipeliner) *_AgeOfUserRNGRelationRedisPipeline {
	...
	return &_AgeOfUserRNGRelationRedisPipeline{m.TxPipeline(), nil}
}
